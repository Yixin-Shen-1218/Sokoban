...
/**
 * <p> The Class PlayState defines the PlayState of GameEngine.
 * Defines a move method under play state. Implements the GameEngineState Class.
 *
 * @author Yixin SHEN
 * @version 1.1
 ...
 * @since 1.0
 */
public class PlayState implements GameEngineState {
    /**
    ...
    /**
     * Constructor of PlayState, set the gameEngine as the current gameEngine.
     * <p> Constructor of PlayState, set the gameEngine as the current gameEngine.
     *
    ...
    /**
     * The keeper move method under PlayState.
    ...
    /**
     * Change the state of gameEngine to DebugState.
     * <p> Change the state of gameEngine to DebugState, set the Debug filed in gameEngine to true.
     *
     * @author Yixin SHEN
    ...
    @Override
    public void debug() {
        gameEngine.setState(gameEngine.getDebugState());
